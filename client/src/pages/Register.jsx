        ...
        <div className="flex items-center justify-center h-screen px-6 bg-gray-200">
            <div className="w-full max-w-sm p-6 bg-white rounded-md shadow-md">
                <div className="flex items-center justify-center">
                    ...
                    <span className="text-2xl font-semibold text-gray-700">Register</span>
                </div>
                ...
                <form className="mt-4">
                    ...
                    <div className="mt-6">
                        <button type="submit" className="w-full px-4 py-2 text-sm text-center text-white bg-indigo-600 rounded-md focus:outline-none hover:bg-indigo-500">
                            Sign in
                        </button>
                    </div>
                </form>
