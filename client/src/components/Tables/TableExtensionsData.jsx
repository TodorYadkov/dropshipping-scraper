                        ...
                        <div className="flex justify-center gap-3">
                            <div className="relative group">
                                <svg
                                    ...
                                    onClick={extension.isWork ? () => onModalClick('StopExtensionModal', { ...extension }) : () => onModalClick('StartExtensionModal', { ...extension })}
                                >
                            ...
                            <div className="relative group">
                                <svg
                                    ...
                                    stroke="#4f46e5"
                                    strokeWidth="50"
                                    onClick={() => onModalClick('LogoutExtensionModal', { ...extension })}
                                >
