                        ...
                        <div className="flex justify-center gap-3">
                            <div className="relative group">
                                <svg
                                    ...
                                    onClick={extension.isWorkBrowser ? (extension.isWork ? () => onModalClick('StopExtensionModal', { ...extension }) : () => onModalClick('StartExtensionModal', { ...extension })) : undefined}
                                >
                            ...
                            <div className="relative group">
                                <svg
                                    ...
                                    stroke="#4f46e5"
                                    strokeWidth="50"
                                    onClick={extension.isWorkBrowser ? () => onModalClick('LogoutExtensionModal', { ...extension }) : undefined}
                                >
                        ...
                        <div className="flex justify-center gap-2">
                            <div className="relative group">
                                <svg
                                    ...
                                    viewBox="0 0 512 512"
                                    onClick={() => onModalClick('EditExtensionModal', { ...extension })}
                                >
                            ...
                            <div className="relative group">
                                <svg
                                    ...
                                    viewBox="0 0 448 512"
                                    onClick={() => onModalClick('DeleteExtensionModal', { ...extension })}
                                >
