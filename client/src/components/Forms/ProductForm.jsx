...
export const ProductForm = ({ toggleModal }) => {
    ...
    async function submitFunction(formData) {
        try {
            setIsLoading(true);
            // TODO fix css on spinner after submitting
    ...
    return (
        <div className="mt-4">
            <div className="w-full overflow-hidden bg-white border shadow-md">
                <form onSubmit={onSubmit} className="w-full">

                    <div className="px-5 text-gray-700 bg-gray-200 border-b">
                        ...
                        <div className="relative mt-2 rounded-md shadow-sm">
                            ...
                            {/* Error Message */}
                            {(formErrors[PRODUCT_FORM_KEYS.AMAZON].isTouched && !!formErrors[PRODUCT_FORM_KEYS.AMAZON].message)
                                && <p className="absolute right-0 bottom-full text-red-500 pb-1">{formErrors[PRODUCT_FORM_KEYS.AMAZON].message}</p>}

                            <input
                                type="text"
                                name={PRODUCT_FORM_KEYS.AMAZON}
                                value={values[PRODUCT_FORM_KEYS.AMAZON]}
                                onChange={onChange}
                                onBlur={onBlur}
                    ...
                    <div className="px-5 pb-6 text-gray-700 bg-gray-200 border-b">
