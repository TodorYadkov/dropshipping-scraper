                ...
                <div className="flex items-center justify-between px-5 py-3">
                    ...
                    {isLoading ? (
                        ...
                        <input
                            type="submit"
                            value="Add"
                            disabled={isInvalidFormHandler()}
                            className={`${isInvalidFormHandler() ? 'cursor-not-allowed bg-indigo-300' : 'cursor-pointer bg-indigo-600 hover:bg-indigo-400'} px-5 py-3 text-sm text-white rounded-md focus:outline-none`} />
                    }
