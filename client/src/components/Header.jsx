        ...
        <>
            <header className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600" >
                <div className="flex items-center">
                    <button className="text-gray-500 focus:outline-none lg:hidden" onClick={() => changeSideBarState(true)}>
                        <svg
                            className="w-6 h-6"
                            viewBox="0 0 24 24"
                            fill="none"
                ...
                <div className="flex items-center">
                    ...
                    <div className="relative">
                        <button className="relative z-10 block w-8 h-8 overflow-hidden rounded-full shadow focus:outline-none" onClick={() => setAvatarDropdownOpen(state => !state)}>
                            <img
                        ...
                        {avatarDropdownOpen && <div className="fixed inset-0 z-10 w-full h-full" onClick={() => setAvatarDropdownOpen(state => !state)} />}
