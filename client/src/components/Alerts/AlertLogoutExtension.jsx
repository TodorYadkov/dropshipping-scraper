...
export const AlertLogoutExtension = ({ toggleModal, extension }) => {
    ...
    return (
        <div className="w-full overflow-hidden bg-gray-200 border shadow-md">
            <div className="w-full bg-gray-100 py-2">
                <p className="text-center py-4 text-lg">Are you sure you want to logout from {extension.extensionName}?</p>
                <div className="flex items-center justify-between px-5 py-3">
                    ...
                    {isLoading ? (
                        ...
                        <input
                            ...
                            onClick={logoutExtensionHandler}
