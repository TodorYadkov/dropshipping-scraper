    ...
    return (
        <>
            <div className="flex">
                ...
                {isOpenSideBar && (
                    <div
                        className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:${isOpenSideBar ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'} lg:static lg:inset-0`}
                    >
