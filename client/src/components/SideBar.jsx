    ...
    return (
        <>
            <div className="flex">
                ...
                <div className={`fixed inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:${isOpenSideBar ? 'translate-x-0 ease-out block' : '-translate-x-full ease-in hidden'} lg:static lg:inset-0 lg:block`} >
                    ...
                    <nav className="mt-10">
                        ...
                        <NavLink className={({ isActive }) => setActiveAndInactiveCss(isActive)} to="/register" >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path
                        ...
                        <NavLink className={({ isActive }) => setActiveAndInactiveCss(isActive)} to="/login" >
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path
                                    d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"
                                />
